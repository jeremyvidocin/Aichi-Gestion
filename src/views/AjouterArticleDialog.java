...
public class AjouterArticleDialog extends JDialog {
    ...
    public AjouterArticleDialog(JFrame parent) {
    ...
    private void initComponents() {
        ...
        prixVenteField = new JFormattedTextField(formatter);
        prixAchatField = new JFormattedTextField(formatter);
